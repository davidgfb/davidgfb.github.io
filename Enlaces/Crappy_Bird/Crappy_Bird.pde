PImage backImg =loadImage("fotos/fondo.png");
PImage birdImg =loadImage("fotos/pajaro.png");
PImage wallImg =loadImage("fotos/tubo.png");
PImage startImg=loadImage("fotos/menu.png");
